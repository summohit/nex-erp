...
let PermissionsController = class PermissionsController {
    ...
    setPermission(req, body) {
        return this.permissionsService.setPermission(req.user.companyId, body.role, body.module, body.action, body.enabled);
    }
};
